...
我們當前 192.168.0.229:443 對應到外網的 140.113.144.123:8443
我們當前 192.168.0.229:22 對應到外網的 140.113.144.123:8880

HPA 要 mongoDB

## 最新目標
ultrathink 請幫我深度分析 @5G-ORAN-1.0.0/backend 和我當前的前端 因為我需要你幫我接上 相對應的 API 或是 Endpoint 同時幫我透過 透過 playwright 來實際測試功能 你可能也需要先深度分析我們當前的 @frontend/ 以及 我們第一個版本的 @5G-ORAN-1.0.0/frontend/ 來找出正確的端點或是 API 來接上。 同時也會需要深度分析 2.0 版本的端點來幫我接上我們當前的系統 @5G-ORAN-2.0.0/new-frontend 和 @5G-ORAN-2.0.0/backend/
