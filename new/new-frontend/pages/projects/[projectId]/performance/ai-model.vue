  ...
  <div class="performance-container">
    ...
    <div class="iframe-wrapper">
      ...
      <div v-else class="placeholder-content">
        ...
        <div class="placeholder-text">AI Model Performance Dashboard</div>
        <div class="placeholder-subtext">
          TODO: 待設定 NUXT_PUBLIC_GRAFANA_AI_MODEL_URL 環境變數
        </div>
      </div>
...
<script setup lang="ts">
  ...
  // 從環境變數取得 Grafana URL
  const grafanaUrl = config.public.grafanaAiModelUrl as string
  ...
  // 預留 projectId 使用
  console.log('Performance AI Model - Project ID:', projectId)
</script>
